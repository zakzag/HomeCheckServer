...
class TNuclearRadiationDetectorDevice extends HasDeviceParams(TDeviceNode) { }
/**
 * This will create all the commands that device can accept besides the default ones
 * (get-info, get-state, set-params, go-sleep)
 */
TNuclearRadiationDetectorDevice.createCommands([]);

export default TNuclearRadiationDetectorDevice;